...
(function() {
  ...
  function loadTasks() {
    ...
    return [
      { id: 'task1', title: 'JavaScript Quiz prep', completed: false },
      { id: 'task2', title: 'Module 2 reading',     completed: false },
      { id: 'task3', title: 'Discussion post',       completed: false },
      { id: 'task4', title: 'Project research',      completed: false }
    ];
  }
  ...
  function updateAvatarColor() {
    ...
    switch (currentUnderstanding) {
      case 'low':    colour = '#E53935'; break; // red
      case 'medium': colour = '#00B0FF'; break; // blue
      case 'high':   colour = '#00C853'; break; // green
      default:       colour = '#C7CBD2'; // grey for none
    }
